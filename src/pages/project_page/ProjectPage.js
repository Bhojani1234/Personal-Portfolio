                            ...
                            >
                              <div className="projectContent">
                                <h5 id={"first"} style={{ color: "#fbd9ad" }}>
                                  Adorn Beauty <br /> hair & beauty testimonials
                                </h5>
                                <img src={nyc} alt={nyc} />
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/Bhojani1234/Adorn_Beauty"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/Bhojani1234/VOTP"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                          ...
                          <Fade bottom>
                            ...
                            >
                              <div className="projectPageContent">
                                <h5 id={"first"} style={{ color: "#fbd9ad" }}>
                                  E-Commerce Website LA COLLECTION
                                </h5>
                                <img src={ci} alt={ci} />
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/Bhojani1234/LA_COLLECTION"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/Bhojani1234/Personal-Portfolio"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/Bhojani1234/Amazing-Meal"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
